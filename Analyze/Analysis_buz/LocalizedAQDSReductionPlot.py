...
fileName = '/Users/Don/Dropbox/group eight/2015-11-14-19 - AQDS Reduction with Shewanella Sudoku Library Parts 1 and 2/Condensed Data/wellColors_interpolated.xml'
...
while i < len(transposonCoordData):
	...
	if rangeLower <= transposonCoord <= rangeUpper and transposonCoord \
	not in selectedTransposonArray:
...
while i < len(circleXArray):
	...
	while j < len(circleYArray):
		...
		uniqueReds.append(currentRed)   #print to ensure use of unique color data 
		tempCircle = Ellipse(wellCircleCenter, width=2*adjustEllipse*circleRadius, \
